            ...
            >
              ...
              <div class="flex flex-col mt-8">
                <div class="flex flex-col gap-y-3">
                  <span class="text-slate-800">وب دیزاینر: شقایق</span>
                  <div class="flex gap-x-2">
                    <span class="text-slate-800">شماره تماس:</span>
                    <span class="text-slate-800" dir="rtl">981233456789+</span>
                  </div>
                  <div class=" flex gap-x-2">
                    <span class="text-slate-800">شماره فکس:</span>
                    <span class="text-slate-800" dir="rtl">81233456789</span>
                  </div>
                </div>
                <hr class="my-5" />
                <div class="flex flex-col gap-y-3 ">
                  <span class="text-slate-800">وب دولوپر-فرانت‌اند: معصومه </span>
                  <div class="flex gap-x-2">
                    <span class="text-slate-800">لینک گیتهاب:</span>
                    <a href="https://github.com/masoumemohebbi">.../github.com</a>
                  </div>
                </div>
              </div>
            </div>
